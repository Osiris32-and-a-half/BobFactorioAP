...
class FactorioBobsModFile(worlds.Files.APPlayerContainer):
    ...
    def write_contents(self, opened_zipfile: zipfile.ZipFile):
        ...
        super(FactorioBobsModFile, self).write_contents(opened_zipfile)


def generate_mod(world: "FactorioBobs", output_directory: str):
    player = world.player
    ...
    mod.writing_tasks.append(lambda: (versioned_mod_name + "/Archipelago/locations.lua",

...
class AdditionalRocketPool(DefaultOnToggle):
    ...
    This is to emulate the Vanilla AP factorio space_science_pack setting but for all Maximum Science Packs.
...
class PercentItemsInGame(Range):
    """The percentage of items in the game considered for randomized recipes.
    Lowering will cause all ingame recipes to become easier.
    If generation fails, try upping this.
    """
    display_name = "Percent Items for randomization"
    range_start = 30
    range_end = 100
    default = 90
...
class FactorioWorldGen(OptionDict):
    ...
    default = {
        "autoplace_controls": {
            ...
            "bob-ground-water": {"frequency": 1, "size": 3, "richness": 6},
            "bob-lead-ore": {"frequency": 1, "size": 3, "richness": 6},
            "bob-lithia-water": {"frequency": 1, "size": 3, "richness": 6},
            "bob-nickel-ore": {"frequency": 1, "size": 3, "richness": 6},
            "bob-quartz": {"frequency": 1, "size": 3, "richness": 6},
            "bob-rutile-ore": {"frequency": 1, "size": 3, "richness": 6},
